    ...
    $(document).ready(function() {
        ...
        var login = {
            ...
            strVerify: function(event) {
                ...
                // alert(strVal)
                var ids = '#' + strName + 'Alt';
                // var email = event.attr("userEmail").val();
                //验证用户名
                if (strName == 'userName') {
                ...
                if (strName == 'password') {
                    ...
                    if (!/^[a-z]\w/.test(strVal)) {
                        $(ids).text("");
                        $(ids).append("<span style=color:#ff7800>密码必须是字符开头</span>");
                    }
                ...
                if(!test){
                    ...
                    $("#userEmailAlt").text("");
                    $('#userEmailAlt').append("<span style='color: green'>邮箱格式正确</span>")
                }
                // alert(email)
            ...
            ajaxSubmit: function() {
                ...
                if ($('#userName').val() == null || $('#userName').val() == '') {
                    ...
                    $('#protocolAlt').text("");
                    $('#protocolAlt').append("<span style=color:#ff7800>请点击注册协议</span>");
                    return false;
